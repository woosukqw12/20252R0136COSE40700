...
# --- 모델 및 토크나이저 경로 ---
model_name = "thunder-research-group/SNU_Thunder-DeID-340M"
tokenizer_path = "/mnt/data3/Korean_abstraction/python/SNU_Thunder-DeID-main/tokenizer/default_tokenizers/mecab_bpe_deid_32k"
...
if __name__ == '__main__':
    ...
    # --------------------------------------------------
        ...
        ckpt_path = '/mnt/data3/Korean_abstraction/python/coreference/results/finetuned_thunder_deid/checkpoint-143325'
        # 1. 훈련된 모델 로드
